    ...
    <main class="auth-page">
      <section class="auth-card">
        ...
        <div class="card-heading">
          <span class="icon"><i class="pi pi-lock"></i></span>
          <div>
            <h1>{{ 'pages.recoverPassword' | translate }}</h1>
            <p>{{ 'pages.recoverPasswordDescription' | translate }}</p>
          </div>
        </div>
        ...
        <form [formGroup]="form" (ngSubmit)="submit()" class="form">
          <div class="field">
            ...
            <small class="error" *ngIf="form.controls.code.invalid && form.controls.code.touched">
          ...
          <p-button type="submit" [disabled]="form.invalid" styleClass="submit-button">
            ...
            <span>{{ 'auth.recoverAction' | translate }}</span>
          </p-button>
        </form>
